...
Page({
  ...
  bjxqmsg_click:function(){
      this.setData({
        bjxqmsg_style: "display:none"
      });
  },

  xjxqbj_click:function(){
      this.setData({
        bjxqmsg_style: "display:block"
      });
      var _this = this;
      var query = wx.createSelectorQuery();
      query.select('.xjxqbj_msg .xjxqbj_msg_c').boundingClientRect()
      query.exec(function (res) {
        _this.setData({
          bjxmgsc_style: "margin-top:-" + res[0].height / 2 + "px"
        });
      });
  },
